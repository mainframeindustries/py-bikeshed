...
Report bugs at https://github.com/kristjanvalur/py-shed/issues
...
https://github.com/kristjanvalur/py-shed/issues.
...
Ready to contribute? Here's how to set up `py-shed` for local
development. Please note this documentation assumes you already have
`poetry` and `Git` installed and ready to go.

| 1. Fork the `py-shed` repo on GitHub. 
...
| 2. Clone your fork locally:
   ...
   .. code-block:: bash
        ...
        git clone git@github.com:YOUR_NAME/py-shed.git
